...
namespace XX
{
	public sealed class BtnContainerRunnerNumCounter : MonoBehaviourAutoRun, IPauseable, IVariableObject, IAlphaSetable, IDesignerBlock
	{
		...
		public BtnContainerNumCounter<aBtnNumCounter> BCon;
