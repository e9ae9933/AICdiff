				...
				if (num <= 2324299930U)
				{
					if (num <= 1141775739U)
					{
						if (num <= 533373674U)
						{
							if (num <= 215681021U)
							{
								if (num != 104373016U)
								{
									...
									if (!(key == "mini_fixcolor"))
									{
										goto IL_0B68;
									}
									this.click_snd = "enter_small";
									this.Skin = new ButtonSkinMiniNel(this, this.w, this.h)
									{
										icon_fix_color = true
									};
									return this.Skin;
						...
						else if (num <= 703916114U)
						{
							...
							{
								if (!(key == "row_smnc_enemy"))
								{
									goto IL_0B68;
								}
								this.click_snd = "tool_drag_init";
								this._SkinRow = new ButtonSkinNelSmncEnemy(this, this.w, this.h);
								this.Skin = this._SkinRow;
								return this.Skin;
							}
						}
						else if (num != 786246507U)
						{
							if (num != 953853289U)
							{
								if (num != 1141775739U)
